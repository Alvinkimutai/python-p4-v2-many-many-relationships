...
employee_meetings = db.Table(
    ...
    db.Column('meeting.id', db.Integer, db.ForeignKey(
...
class Employee(db.Model):
    ...
    # Relationship mapping the employee to related assingments
    assingments = db.relationship('Assingment', back_populates='employee', cascade = 'all, delete-orphan')
...
class Project(db.Model):
    ...
    #relationship mapping project to related assingments

    assingments = db.relationship('Assingment', back_populates = 'project', cascade = 'all, delete-orphan')

    # Association proxy to get projects for this employee through the assignments
...
class Assignment(db.Model):
    ...
    # relationship mapping assingment to related project

    project = db.relationship('Project', back_populates = 'assingments')